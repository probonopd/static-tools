...
make -j$(nproc)
gcc -static mksquashfs.o read_fs.o action.o swap.o pseudo.o compressor.o sort.o progressbar.o read_file.o info.o restore.o process_fragments.o caches-queues-lists.o gzip_wrapper.o xattr.o read_xattrs.o /usr/lib/crt1.o /usr/lib/libc.a -lm -lz -o mksquashfs
gcc -static unsquashfs.o unsquash-1.o unsquash-2.o unsquash-3.o unsquash-4.o unsquash-123.o unsquash-34.o swap.o compressor.o unsquashfs_info.o gzip_wrapper.o read_xattrs.o unsquashfs_xattr.o /usr/lib/crt1.o /usr/lib/libc.a -lm -lz -o unsquashfs
...
make -j$(nproc)	
cd src/
gcc -static -o desktop-file-validate keyfileutils.o validate.o validator.o -lglib-2.0 -lintl /usr/lib/crt1.o /usr/lib/libc.a
gcc -static -o update-desktop-database  update-desktop-database.o -lglib-2.0 -lintl /usr/lib/crt1.o /usr/lib/libc.a
gcc -static -o desktop-file-install keyfileutils.o validate.o install.o  -lglib-2.0 -lintl /usr/lib/crt1.o /usr/lib/libc.a
...
make -j$(nproc)
gcc -static -o bsdtar tar/bsdtar-bsdtar.o tar/bsdtar-cmdline.o tar/bsdtar-creation_set.o tar/bsdtar-read.o tar/bsdtar-subst.o tar/bsdtar-util.o tar/bsdtar-write.o .libs/libarchive.a .libs/libarchive_fe.a /lib/libz.a /usr/lib/crt1.o /usr/lib/libc.a
strip bsdtar
cd ..
